...
class wpda_contdown_extend_library {
	...
	public static function create_table_heading($heading_name,$heading_group){
		?>
			<tr class="<?php echo esc_html($heading_group); ?> tr_heading"><th colspan="2"><?php echo stripslashes(wp_filter_post_kses($heading_name)); ?></th></tr>
		<?php		
	}
		...
		?>
			<td class="td_option_description">				 
				 <?php if(isset($args['description']) && $args['description'] != "") { ?>
					<span class="wpdevart-info-container">?<span class="wpdevart-info"><?php echo esc_html($args['description']); ?></span></span>
				 <?php } ?>
	...
	public static function simple_input($args){
		...
		<tr class="<?php echo isset($args['heading_group'])?$args['heading_group']:'' ?> tr_option">
			...
			<td class="<?php echo ((isset($args["pro"]) && $args["pro"] === true)) ? "wpda_countdown_extended_pro_feature" : ""; ?>">
					<input type="<?php echo isset($args['type'])?esc_html($args['type']):'text'; ?>" value="<?php echo esc_html($args['value']); ?>" id="<?php echo esc_html($args['name']); ?>" name="<?php echo esc_html($args['name']); ?>">
	...
	public static function many_inputs($args){
		...
		<tr class="<?php echo isset($args['heading_group'])?$args['heading_group']:'' ?> tr_option">
			...
			<td class="<?php echo ((isset($args["pro"]) && $args["pro"] === true)) ? "wpda_countdown_extended_pro_feature" : ""; ?>">
				...
				<input type="<?php echo isset($args['type'][$key])?esc_html($args['type'][$key]):'text'; ?>" value="<?php echo esc_html($args['value'][$key]); ?>" id="<?php echo esc_html($args['name']."_".$key."_id"); ?>" name="<?php echo esc_html($args['name']."[".$key."]"); ?>">
				<small><?php echo isset($args['small_text'][$key])?esc_html($args['small_text'][$key]):''; ?></small>
				<?php } ?>
			</td>
		</tr>
		<?php		
	...
	public static function color_input($args){
		...
		<tr class="<?php echo isset($args['heading_group'])?$args['heading_group']:'' ?> tr_option">
			...
			<td class="<?php echo ((isset($args["pro"]) && $args["pro"] === true)) ? "wpda_countdown_extended_pro_feature" : ""; ?> wpda_color-picker">
				<input type="text" class="color" value="<?php echo esc_html($args['value']); ?>" data-default-color="<?php echo esc_html($args["default_value"]); ?>" id="<?php echo esc_html($args['name']); ?>" name="<?php echo esc_html($args['name']); ?>">
				<script  type="text/javascript">
					jQuery(document).ready(function() {
						jQuery('#<?php echo esc_html($args['name']); ?>').wpColorPicker();
					});
				</script>
			</td>
		</tr>
	...
	public static function simple_select($args){
		...
		?>
		<tr class="<?php echo isset($args['heading_group'])?esc_html($args['heading_group']):'' ?> tr_option">
			<?php self::generete_standart_description_panel($args) ?>
			<td class="<?php echo ((isset($args["pro"]) && $args["pro"] === true)) ? "wpda_countdown_extended_pro_feature" : ""; ?>">
				<select id="<?php echo esc_html($args['name']); ?>" name="<?php echo esc_html($args['name']); ?>">
					<?php foreach($args['values'] as $key => $value){ 
						if(!is_array($value)){
							?><option value="<?php echo esc_html($key); ?>" <?php selected($key,$curent_value)  ?>><?php echo esc_html($value); ?></option><?php
						}else{
							?><optgroup label="<?php echo str_replace("_"," ",$key) ?>"><?php
							foreach($value as $key1 => $value1){
								?><option value="<?php echo esc_html($key1); ?>" <?php selected($key1,$curent_value)  ?>><?php echo esc_html($value1); ?></option><?php
							}
							?></optgroup><?php
						}
					} ?>
	...
	public static function font_select($args){
		...
		<tr class="<?php echo isset($args['heading_group'])?$args['heading_group']:'' ?> tr_option">
			...
			<td class="<?php echo ((isset($args["pro"]) && $args["pro"] === true)) ? "wpda_countdown_extended_pro_feature" : ""; ?>">
				<select id="<?php echo esc_html($args['name']); ?>" name="<?php echo esc_html($args['name']); ?>">
					<?php foreach($args['values'] as $key => $value){ 						
						?><option style="font-family:<?php echo esc_html($key); ?>" value="<?php echo esc_html($key); ?>" <?php selected($key,$curent_value)  ?>><?php echo esc_html($value) ?></option><?php						
					} ?>
				</select>
			</td>
		</tr>
	...
	public static function simple_checkbox($args){
		...
		<tr class="<?php echo isset($args['heading_group'])?$args['heading_group']:'' ?> tr_option checkbox_tr">
			...
			<td class="td_value <?php echo ((isset($args["pro"]) && $args["pro"] === true)) ? "wpda_countdown_extended_pro_feature" : ""; ?>">
				...
				<div>
					<span>
						<input <?php if(isset($curent_value) && in_array($key, $curent_value)){ echo 'checked="checked"'; } ?> type="checkbox" name="<?php echo esc_html($args['name']); ?>[<?php echo esc_html($key); ?>]" id="<?php echo esc_html($args['name'].$key); ?>_id" value="<?php echo esc_html($key); ?>">
						<label for="<?php echo esc_html($args['name'].$key); ?>_id"><?php echo esc_html($value); ?></label>
					</span>
				</div>
				<?php } ?>
			</td>
	...
	public static function padding_margin_input($args){
		...
		<tr class="<?php echo isset($args['heading_group'])?$args['heading_group']:'' ?> tr_option tr_pading_margin">
			...
			<?php if(isset($args['values']["top"])){  ?>
				<span>
					<input type="text" name="<?php echo esc_html($args['name']); ?>[top]" id="<?php echo esc_html($args['name']); ?>_top_id" value="<?php echo esc_html($args['value']["top"]); ?>">
					<label for="<?php echo esc_html($args['name']); ?>_top_id">Top(px)</label>
				</span>
			<?php } ?>
			<?php if(isset($args['values']["right"])){  ?>
				<span>
					<input type="text" name="<?php echo esc_html($args['name']); ?>[right]" id="<?php echo esc_html($args['name']); ?>_right_id" value="<?php echo esc_html($args['value']["right"]); ?>">
					<label for="<?php echo $args['name']; ?>_right_id">Right(px)</label>
				</span>
			<?php } ?>
			<?php if(isset($args['values']["bottom"])){  ?>		
				<span>
					<input type="text" name="<?php echo esc_html($args['name']); ?>[bottom]" id="<?php echo esc_html($args['name']); ?>_bottom_id" value="<?php echo esc_html($args['value']["bottom"]); ?>">
					<label for="<?php echo esc_html($args['name']); ?>_bottom_id">Bottom(px)</label>
				</span>
				<?php } ?>
			<?php if(isset($args['values']["left"])){  ?>
				<span>
					<input type="text" name="<?php echo esc_html($args['name']); ?>[left]" id="<?php echo esc_html($args['name']); ?>_left_id" value="<?php echo esc_html($args['value']["left"]); ?>">
					<label for="<?php echo esc_html($args['name']); ?>_left_id">Left(px)</label>
				</span>	
			<?php } ?>
			</td>
		</tr>
	...
	public static function simple_select_extend_font_size($args){
		...
		<tr class="<?php echo isset($args['heading_group'])?$args['heading_group']:'' ?> tr_option">
			<?php self::generete_standart_description_panel($args) ?>
			<td class="<?php echo ((isset($args["pro"]) && $args["pro"] === true)) ? "wpda_countdown_extended_pro_feature" : ""; ?>">
				<select style="font-family: 'Material Icons','FontAwesome',Arial;" name="<?php echo esc_html($args['name']); ?>">
					<?php foreach($args['values'] as $key => $value){ ?>
						<option class="<?php echo esc_html($value[1]) ?>" value="<?php echo esc_html($key) ?>" <?php selected($key,$curent_value)  ?>><?php echo esc_html($value[0]); ?></option>
					<?php } ?>
				</select>
			</td>
		</tr>
	...
	public static function range_input($args){
		...
		<tr class="<?php echo isset($args['heading_group'])?$args['heading_group']:'' ?> tr_option">
			...
			<td class="range_option_td <?php echo ((isset($args["pro"]) && $args["pro"] === true)) ? "wpda_countdown_extended_pro_feature" : ""; ?>">
				<input oninput="document.getElementById('<?php echo $args['name']; ?>_conect').innerHTML=this.value" type="range" id="<?php echo esc_html($args['name']); ?>" name="<?php echo esc_html($args['name']); ?>" value="<?php echo $args['value'] ?>" <?php echo $min." ".$max; ?> />
                <output id="<?php echo esc_html($args['name']); ?>_conect" ><?php echo esc_html($args['value']); ?></output>
                <small><?php echo isset($args['small_text'])?esc_html($args['small_text']):''; ?></small>
			</td>
		</tr>
		<?php	
	}
	public static function upload_input($args){
		...
		<tr class="<?php echo isset($args['heading_group'])?$args['heading_group']:'' ?> tr_option">
			...
			<td class="upload_option_td <?php echo ((isset($args["pro"]) && $args["pro"] === true)) ? "wpda_countdown_extended_pro_feature" : ""; ?>">
				<input type="text" class="upload" id="<?php echo esc_html($args['name']); ?>" name="<?php echo esc_html($args['name']); ?>" value="<?php echo esc_html($args['value']); ?>">
				<input class="upload-button button" type="button" value="Upload">
				<img src="<?php echo esc_html($args['value']); ?>" class="cont_button_uploaded_img">	      
			</td>
		</tr>
		<?php	
	}
	...
	public static function calendar_input($args){
		...
		<tr class="<?php echo isset($args['heading_group'])?$args['heading_group']:'' ?> tr_option">
			<?php self::generete_standart_description_panel($args) ?>
			<td class="<?php echo ((isset($args["pro"]) && $args["pro"] === true)) ? "wpda_countdown_extended_pro_feature" : ""; ?>">
				<input class="wpda_datepicker_timer" type="<?php echo isset($args['type'])?esc_html($args['type']):'text'; ?>" value="<?php echo esc_html($args['value']); ?>" name="<?php echo esc_html($args['name']); ?>">
			</td>
		</tr>
		<?php		
	}
	public static function tinmce($args){		
		...
		<tr  class="<?php echo isset($args['heading_group'])?$args['heading_group']:'' ?> tr_option">
			<td class="<?php echo ((isset($args["pro"]) && $args["pro"] === true)) ? "wpda_countdown_extended_pro_feature" : ""; ?>" colspan="2" style="padding: 4px;">
				<?php wp_editor( stripslashes(wp_filter_post_kses($args['value'])), esc_html($args['name']), $settings = array() ); ?>
			</td>
		</tr>
		<?php		
	}
	public static function oredering($args){	
		...
		<tr  class="<?php echo isset($args['heading_group'])?esc_html($args['heading_group']):'' ?> tr_option">
			...
			<td class="<?php echo ((isset($args["pro"]) && $args["pro"] === true)) ? "wpda_countdown_extended_pro_feature" : ""; ?>"  style="padding: 4px;">
				<ul class="wpdevart_sortable" id="<?php echo esc_html($args['name']); ?>_ul">
					<?php foreach($ordering_info as $key =>$value){ 
						echo '<li date-value="'.esc_html($key).'"  class="ui-state-default '.( $value[0] ? " control_active ":" control_deactive ").'">'.esc_html($ordering_elements[$key]).'<span class="ui-icon ui-icon-arrowthick-2-n-s"></span></li>';
					 } ?>
				 </ul>
				<input type="hidden" name="<?php echo esc_html($args['name']); ?>" id="<?php echo esc_html($args['name']); ?>" value='<?php echo stripslashes(esc_html($args['value'])) ?>'  />				
			</td>
		</tr>
		<?php		
	}

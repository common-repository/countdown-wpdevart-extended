...
* Plugin URI: https://wpdevart.com/wordpress-countdown-extended-version/
...
class wpda_countdown_extend{
	...
	public function registr_requeried_scripts(){		
		...
		wp_register_style( 'wpdevart-countdown-extended-jquery-ui', wpda_contdown_extend_plugin_url.'includes/admin/css/jquery-ui-style.css' );		
	...
	private function call_base_filters(){
		...
		// widget
		add_action('widgets_init',  array($this,'wpda_countdown_extended_widget'));
  	...
  	private function define_constants(){
		 ...
		 define('wpdevart_countdown_extended_support_url',"https://wordpress.org/support/plugin/countdown-wpdevart-extended/");
	...
	public function wpda_countdown_extended_widget(){
		return register_widget("wpdevart_countdown_extended");
	}
